...
export class PedidosService {
  ...
  async create(createPedidoDto: CreatePedidoDto) {
    ...
    // Dispara a mensagem de confirmação no WhatsApp
    ...
    // envio roda em background para não travar o retorno da requisição
